define(['exports', 'react', 'create-react-class', 'prop-types', 'classnames', 'shortid', './check-props', '../utilities/dialog', '../icon', '../utilities/menu-list', '../utilities/menu-list/item-label', '../utilities/pill', '../../utilities/keyboard-navigable-menu', '../../utilities/event', '../../utilities/key-code', '../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _classnames, _shortid, _checkProps, _dialog, _icon, _menuList, _itemLabel, _pill, _keyboardNavigableMenu, _event, _keyCode, _constants) {
	'use strict';
