define(['exports', 'react', 'create-react-class', 'prop-types', 'react-dom', 'lodash.assign', 'classnames', 'lodash.isboolean', 'lodash.isfunction', 'shortid', '../utilities/dialog', '../utilities/menu-list', '../utilities/menu-list/item', '../utilities/menu-list/item-label', './button-trigger', './check-props', '../../utilities/keyboard-navigable-menu', '../../utilities/event', '../../utilities/key-code', '../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _reactDom, _lodash, _classnames, _lodash3, _lodash5, _shortid, _dialog, _menuList, _item, _itemLabel, _buttonTrigger, _checkProps, _keyboardNavigableMenu, _event, _keyCode, _constants) {
	'use strict';
