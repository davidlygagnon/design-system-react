...
function (_React$Component) {
  ...
  function Popover() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDialog", function (isOpen, outsideClickIgnoreClass) {
      ...
      var headerVariants = {
        base: _react.default.createElement("header", {
      ...
      if (props.variant === 'error' || props.variant === 'warning') {
        ...
        _react.default.createElement("div", null, _react.default.createElement("div", {
          ...
          className: (0, _classnames.default)('slds-popover__body slds-popover__body_scrollable', _this.props.classNameBody) // REMOVE IN THE FUTURE: SLDS OVERRIDE
          // Possible solution in future is to use .slds-popover__body_small
          ,
          style: {
            borderBottom: 'none'
          }
        }, props.body), _react.default.createElement("div", {
        ...
        }, props.heading ? _react.default.createElement("h2", {
          className: "slds-text-heading_small"
        }, props.heading) : null, props.body, props.stepText ? _react.default.createElement("p", {
      ...
      if (props.footer) {
        ...
        }, props.stepText ? _react.default.createElement("span", {
          className: "slds-text-title"
        }, props.stepText) : null, props.footerWalkthroughActions ? _react.default.createElement("div", {
  ...
  _createClass(Popover, [{
    ...
    value: function componentWillMount() {
      this.generatedId = _shortid.default.generate(); // `checkProps` issues warnings to developers about properties (similar to React's built in development tools)

      (0, _checkProps.default)(_constants.POPOVER, this.props, _docs.default);
    }
  }, {
    ...
    value: function render() {
      ...
      _react.default.Children.forEach(this.props.children, function (child, index) {
        if (index === 0) {
          clonedTrigger = _react.default.cloneElement(child, _objectSpread({
            id: _this2.getId(),
...
_defineProperty(Popover, "propTypes", {
   ...
   */
  variant: _propTypes.default.oneOf(['base', 'error', 'walkthrough', 'walkthrough-action', 'warning'])
});
