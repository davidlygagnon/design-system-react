...
function (_React$Component) {
  ...
  function ColorPicker(props) {
    ...
    var workingColor = _color2.default.getNewColor({
      hex: _this.props.valueWorking || _this.props.value || _this.props.swatchColors[0]
    }, _this.props.events.onValidateWorkingColor);

    _this.state = {
      currentColor: _this.props.value || _this.props.swatchColors[0],
  ...
  _createClass(ColorPicker, [{
    ...
    value: function componentWillMount() {
      (0, _checkProps2.default)(_constants.COLOR_PICKER, this.props);
    ...
    value: function getDefaultTab() {
      return (this.props.variant === 'base' || this.props.variant === 'swatches') && _react2.default.createElement(_panel2.default, {
        label: this.props.labels.swatchTab
    ...
    value: function getPopover() {
      ...
      }, this.getDefaultTab(), this.getCustomTab());
    ...
    value: function handleColorChange(property) {
      ...
      return function (event) {
        ...
        _this2.setWorkingColor(event, colorProperties);
      };
    }
  }, {
    key: "handleNavigate",
    value: function handleNavigate(property) {
      ...
      return function (event, _ref) {
        ...
        var newColor = _color2.default.getDeltaColor(colorProperties, _this3.props.events.onValidateWorkingColor, _this3.state.workingColor);

        _this3.setState({
          workingColor: newColor,
          previousWorkingColor: _this3.state.workingColor
        });

        if (_this3.props.events.onWorkingColorChange) {
          _this3.props.events.onWorkingColorChange(event, {
            color: newColor
          });
        }
      };
    ...
    value: function render() {
      ...
      }, this.props.labels.label), this.getPopover(), this.getInput(), !this.state.isOpen && this.state.colorErrorMessage ? _react2.default.createElement("p", {
...
var _initialiseProps = function _initialiseProps() {
  ...
  Object.defineProperty(this, "handleOnRequestClose", {
    ...
    value: function value(event, _ref2) {
      ...
      if (trigger === 'clickOutside' || trigger === 'cancel') {
        _this5.handleCancelState();
      }

      if (_this5.props.onRequestClose) {
        _this5.props.onRequestClose(event, {
          trigger: trigger
        });
      }
    }
  ...
  Object.defineProperty(this, "handleClickOutside", {
    ...
    writable: true,
    value: function value(event) {
      _this5.handleCancelButtonClick(event);
    }
  });
  ...
  Object.defineProperty(this, "handleCancelState", {
    ...
    value: function value() {
      var workingColor = _color2.default.getNewColor({
        hex: _this5.state.currentColor
      }, _this5.props.events.onValidateWorkingColor);
  ...
  Object.defineProperty(this, "handleHexInputChange", {
    ...
    value: function value(event) {
      ...
      var isValid = _this5.props.events.onValidateColor ? _this5.props.events.onValidateColor(event.target.value) : _color2.default.isValidHex(event.target.value);

      _this5.setState({
        currentColor: currentColor,
        colorErrorMessage: isValid ? '' : _this5.props.labels.invalidColor
      });

      if (_this5.props.events.onChange) {
        _this5.props.events.onChange(event, {
          color: currentColor,
          isValid: isValid
        });
      }
  ...
  Object.defineProperty(this, "handleSubmitButtonClick", {
    ...
    value: function value(event) {
      _this5.setState({
        isOpen: false,
        currentColor: _this5.state.workingColor.hex,
        colorErrorMessage: ''
      });

      if (_this5.props.events.onChange) {
        _this5.props.events.onChange(event, {
          color: _this5.state.workingColor.hex,
          isValid: true
        });
      }
    }
  ...
  Object.defineProperty(this, "handleSwatchButtonClick", {
    ...
    value: function value() {
      var workingColor = _color2.default.getNewColor({
        hex: _this5.state.workingColor.hex
      }, _this5.props.events.onValidateWorkingColor);

      _this5.setState({
        isOpen: !_this5.state.isOpen,
        workingColor: workingColor,
        previousWorkingColor: _this5.state.previousWorkingColor
      });

      if (_this5.props.onRequestOpen) {
        _this5.props.onRequestOpen();
      }
    }
  });
