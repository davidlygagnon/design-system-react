...
function (_React$Component) {
  ...
  function ColorPicker(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleHexInputChange", function (event, _ref2) {
      ...
      var isValid = _this.props.events.onValidateColor ? _this.props.events.onValidateColor(event.target.value) : _color.default.isValidHex(event.target.value);
    ...
    _this.generatedId = _this.props.id || _shortid.default.generate();
  ...
  _createClass(ColorPicker, [{
    ...
    value: function componentWillMount() {
      (0, _checkProps.default)(_constants.COLOR_PICKER, this.props, _docs.default);
    ...
    value: function getInput(_ref5) {
      ...
      return this.props.hideInput ? null : _react.default.createElement(_input.default, {
    ...
    value: function getDefaultTab(_ref6) {
      ...
      return (this.props.variant === 'base' || this.props.variant === 'swatches') && _react.default.createElement(_panel.default, {
        label: labels.swatchTab
      }, _react.default.createElement(_swatchPicker.default, {
    ...
    value: function getCustomTab(_ref7) {
      ...
      return (this.props.variant === 'base' || this.props.variant === 'custom') && _react.default.createElement(_panel.default, {
        label: labels.customTab
      }, _react.default.createElement(_customColor.default, {
    ...
    value: function getPopover(_ref8) {
      ...
      var popoverBody = _react.default.createElement(_tabs.default, {
      ...
      var popoverFooter = _react.default.createElement("div", {
      ...
      return _react.default.createElement(_popover.default, {
        ...
        label: _react.default.createElement(_swatch.default, {
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        labels: labels
      }), !this.state.isOpen && this.state.colorErrorMessage ? _react.default.createElement("p", {
