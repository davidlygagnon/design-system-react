define(['exports', 'react', 'prop-types', 'lodash.assign', 'lodash.isboolean', 'classnames', 'shortid', '../utilities/dialog', './private/calendar-wrapper', '../icon/input-icon', '../forms/input', './check-props', '../../utilities/event', '../../utilities/key-code', '../../utilities/constants'], function (exports, _react, _propTypes, _lodash, _lodash3, _classnames, _shortid, _dialog, _calendarWrapper, _inputIcon, _input, _checkProps, _event, _keyCode, _constants) {
	'use strict';
