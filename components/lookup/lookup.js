define(['exports', 'react', 'create-react-class', 'prop-types', 'lodash.escaperegexp', 'lodash.isboolean', 'lodash.isequal', 'classnames', './check-props', '../utilities/dialog', '../button', '../icon', '../icon/input-icon', '../forms/input', '../../utilities/event', '../../utilities/key-code', './menu', '../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _lodash, _lodash3, _lodash5, _classnames, _checkProps, _dialog, _button, _icon, _inputIcon, _input, _event, _keyCode, _menu, _constants) {
	'use strict';
