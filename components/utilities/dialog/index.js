define(['exports', 'react', 'create-react-class', 'prop-types', 'popper.js', 'lodash.isequal', 'classnames', './portal', '../../../utilities/event', '../../../utilities/key-code', '../../../utilities/dom-element-focus', '../../../utilities/dialog-helpers', '../../../utilities/constants', '../../icon-settings'], function (exports, _react, _createReactClass, _propTypes, _popper, _lodash, _classnames, _portal, _event, _keyCode, _domElementFocus, _dialogHelpers, _constants, _iconSettings) {
	'use strict';
  ...
  */
    ...
    */
			...
			onRequestMenuElement: _propTypes2.default.func.isRequired,
			/**
    ...
    */
		...
		render: function render() {
			...
			if (this.props.inheritTargetWidth && this.props.onRequestTargetElement()) {
				...
				//style.width = this.props.onMenuTargetElement.getBoundingClientRect().width;
			} else if (this.props.onRequestMenuElement()) {
				style.width = this.props.onRequestMenuElement().getBoundingClientRect().width;
			}
