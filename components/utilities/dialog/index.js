...
var _languageDirection = _interopRequireDefault(require("../direction/private/language-direction"));
...
function (_React$Component) {
  ...
  function Dialog() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getPopperStyles", function () {
      ...
      var right = 'inherit';
      var leftValue = _this.props.direction === _direction.DIRECTIONS.RTL ? right : left;
      var rightValue = _this.props.direction === _direction.DIRECTIONS.RTL ? 0 : right;
  ...
  _createClass(Dialog, [{
    ...
    value: function render() {
      ...
      var contents = _react.default.createElement("section", _extends({
      ...
      var subRenders = {
        ...
        overflowBoundaryElement: function overflowBoundaryElement() {
          ...
          }, _react.default.createElement(_iconSettings.default, truthyIconSettingsContext, contents));
        }
      };
