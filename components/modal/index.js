...
function (_React$Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps.default)(_constants.MODAL, this.props, _docs.default);
      ...
      if (this.state.isClosing !== prevState.isClosing) {
        if (this.state.isClosing) {
          ...
          if (!this.isUnmounting) {
            var el = _reactDom.default.findDOMNode(this); // eslint-disable-line react/no-find-dom-node
    ...
    value: function getModal() {
      ...
      return (// temporarily disabling eslint for the onClicks on the div tags
        ...
        _react.default.createElement("section", {
          ...
          style: modalStyle
        }, this.headerComponent(), _react.default.createElement("div", {
    ...
    value: function headerComponent() {
      ...
      var closeButton = _react.default.createElement(_button.default, {
        assistiveText: {
      ...
      if (!headerContent && (this.props.heading || this.props.title) || this.props.tagline) {
        headerContent = _react.default.createElement("div", null, this.props.toast, _react.default.createElement("h2", {
          className: (0, _classnames.default)({
            'slds-text-heading_small': this.isPrompt(),
            'slds-text-heading_medium': !this.isPrompt()
          }),
          id: "".concat(this.getId(), "-heading")
        }, this.props.heading ? this.props.heading : this.props.title), this.props.tagline ? _react.default.createElement("p", {
    ...
    value: function render() {
      ...
      }, this.getModal(), _react.default.createElement("div", {
