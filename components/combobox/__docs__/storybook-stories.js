...
var _baseInlineHelpTooltip = require("../__examples__/base-inline-help-tooltip");

var _baseInlineHelpTooltip2 = _interopRequireDefault(_baseInlineHelpTooltip);
...
var _baseMenuItemDisabled = require("../__examples__/base-menu-item-disabled");

var _baseMenuItemDisabled2 = _interopRequireDefault(_baseMenuItemDisabled);

var _baseMenuItemDisabledTooltip = require("../__examples__/base-menu-item-disabled-tooltip");

var _baseMenuItemDisabledTooltip2 = _interopRequireDefault(_baseMenuItemDisabledTooltip);
...
var _baseCustomMenuItemDisabled = require("../__examples__/base-custom-menu-item-disabled");

var _baseCustomMenuItemDisabled2 = _interopRequireDefault(_baseCustomMenuItemDisabled);

var _readonlySingle = require("../__examples__/readonly-single");

var _readonlySingle2 = _interopRequireDefault(_readonlySingle);

var _readonlyMenuItemDisabled = require("../__examples__/readonly-menu-item-disabled");

var _readonlyMenuItemDisabled2 = _interopRequireDefault(_readonlyMenuItemDisabled);
...
(0, _react3.storiesOf)(_constants.COMBOBOX, module).addDecorator(function (getStory) {
  ...
  }, "Field Level Help Tooltip"), _react2.default.createElement(_baseInlineHelpTooltip2.default, {
    action: _addonActions.action
  }));
}).add('Base Menu Item Disabled', function () {
  return _react2.default.createElement(_baseMenuItemDisabled2.default, {
    action: _addonActions.action
  });
}).add('Base Menu Item Disabled With Tooltip', function () {
  return _react2.default.createElement(_baseMenuItemDisabledTooltip2.default, {
    action: _addonActions.action
  });
  ...
  return _react2.default.createElement(_baseCustomMenuItemDisabled2.default, {
    action: _addonActions.action
  });
  ...
  return _react2.default.createElement(_readonlyMenuItemDisabled2.default, {
    action: _addonActions.action
  });
