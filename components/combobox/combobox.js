  ...
  */
   ...
   */
		labels: _propTypes2.default.shape({
			...
			labelRequired: _propTypes2.default.boolean,
					...
					_react2.default.createElement(
						'div',
						{
							className: (0, _classnames2.default)('slds-combobox', 'slds-dropdown-trigger', 'slds-dropdown-trigger_click', 'ignore-react-onclickoutside', {
								...
								'slds-has-error': _this3.props.errorText
							}, props.className),
						...
						_this3.props.errorText && _react2.default.createElement(
							'div',
							{ id: _this3.getErrorId(), className: 'slds-form-element__help' },
							_this3.props.errorText
						),
						_this3.getDialog({
