define(['exports', 'react', 'prop-types', 'lodash.assign', 'lodash.find', 'lodash.reject', 'lodash.isequal', 'lodash.findindex', 'lodash.isboolean', 'lodash.isfunction', 'classnames', 'shortid', '../utilities/dialog', '../../components/forms/input/private/inner-input', '../icon/input-icon', './private/menu', '../forms/private/label', './private/selected-listbox', '../../utilities/key-code', '../../utilities/key-callbacks', './check-props', '../../utilities/constants'], function (exports, _react, _propTypes, _lodash, _lodash3, _lodash5, _lodash7, _lodash9, _lodash11, _lodash13, _classnames, _shortid, _dialog, _innerInput, _inputIcon, _menu, _label, _selectedListbox, _keyCode, _keyCallbacks, _checkProps, _constants) {
	'use strict';
   ...
   */
		...
		/**
   * Sets the dialog width to the width of the menu. If setting this to true
   * Note that you may want to set a menuMaxWidth. If not, width will be set to width of larget menu item.
   */
   ...
   */
	...
	var _initialiseProps = function _initialiseProps() {
		...
		this.getNewActiveOptionIndex = function (_ref2) {
			...
			var skipIndex = options.length > nextIndex && options[nextIndex].type === 'separator';
		...
		this.handleNavigateListboxMenu = function (event, _ref3) {
		...
		this.handleNavigateListboxOfPills = function (event, _ref4) {
		...
		this.handlePillClickListboxOfPills = function (event, _ref5) {
		...
		this.handleRemoveSelectedOption = function (event, _ref6) {
		...
		this.handleRequestFocusListboxOfPills = function (event, _ref7) {
			var ref = _ref7.ref;
		...
		this.handleSelect = function (event, _ref8) {
		...
		this.isSelected = function (_ref9) {
		...
		this.renderBase = function (_ref10) {
		...
		this.renderInlineMultiple = function (_ref11) {
		...
		this.renderMenu = function (_ref13) {
		...
		this.renderReadOnlyMultiple = function (_ref14) {
