define(['exports', 'react', 'prop-types', '../utilities/dialog', '../../components/forms/input/private/inner-input', '../icon/input-icon', './private/menu', '../forms/private/label', './private/selected-listbox', 'lodash.assign', 'lodash.find', 'lodash.reject', 'lodash.isequal', 'lodash.findindex', 'airbnb-prop-types', 'lodash.isboolean', 'lodash.isfunction', 'classnames', 'shortid', '../../utilities/key-code', '../../utilities/key-callbacks', './check-props', '../../utilities/constants'], function (exports, _react, _propTypes, _dialog, _innerInput, _inputIcon, _menu, _label, _selectedListbox, _lodash, _lodash3, _lodash5, _lodash7, _lodash9, _airbnbPropTypes, _lodash11, _lodash13, _classnames, _shortid, _keyCode, _keyCallbacks, _checkProps, _constants) {
   ...
   */
		...
		inheritMenuRendererWidth: _propTypes2.default.bool,
		/**
   ...
   */
			...
			value: function getDialog(_ref) {
				...
				return !this.props.disabled && this.getIsOpen() ? _react2.default.createElement(
					_dialog2.default,
					{
						...
						inheritMenuRendererWidth: this.props.inheritMenuRendererWidth,
	...
	var _initialiseProps = function _initialiseProps() {
		...
		this.getNewActiveOptionIndex = function (_ref2) {
			...
			return hasNewIndex ? newIndex + (options[newIndex].type === 'separator' ? offset : 0) : activeOptionIndex;
		};
