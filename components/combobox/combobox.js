...
var _selectedListbox = require("../pill-container/private/selected-listbox");
...
var _keyLetterMenuItemSelect = require("../../utilities/key-letter-menu-item-select");

var _keyLetterMenuItemSelect2 = _interopRequireDefault(_keyLetterMenuItemSelect);

var _keyCallbacks = require("../../utilities/key-callbacks");

var _keyCallbacks2 = _interopRequireDefault(_keyCallbacks);

var _menuItemSelectScroll = require("../../utilities/menu-item-select-scroll");

var _menuItemSelectScroll2 = _interopRequireDefault(_menuItemSelectScroll);
...
var propTypes = {
   ...
   */
  options: _propTypes2.default.arrayOf(_propTypes2.default.PropTypes.shape({
   ...
   */
  selection: _propTypes2.default.arrayOf(_propTypes2.default.PropTypes.shape({
    id: _propTypes2.default.string.isRequired,
    icon: _propTypes2.default.node,
    label: _propTypes2.default.string,
    subTitle: _propTypes2.default.string,
...
function (_React$Component) {
  ...
  function Combobox(props) {
    ...
    _this.menuKeyBuffer = new _keyBuffer2.default();
  ...
  _createClass(Combobox, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps2.default)(_constants.COMBOBOX, this.props, _docs2.default);
    ...
    value: function render() {
      ...
      var hasRenderedLabel = labels.label || assistiveText && assistiveText.label;
...
var _initialiseProps = function _initialiseProps() {
  ...
  Object.defineProperty(this, "getIsOpen", {
    ...
    writable: true,
    value: function value() {
      return !!(typeof _this3.props.isOpen === 'boolean' ? _this3.props.isOpen : _this3.state.isOpen);
    }
  });
  ...
  Object.defineProperty(this, "setSelectedListboxRef", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(ref) {
      _this3.selectedListboxRef = ref;

      if (_this3.props.selectedListboxRef) {
        _this3.props.selectedListboxRef(ref);
      }
    }
  });
  ...
  Object.defineProperty(this, "handleInputBlur", {
    ...
    value: function value(event) {
      ...
      setTimeout(function () {
        ...
        if (activeElement && activeElement.tagName === 'DIV' && activeElement.id === "".concat(_this3.getId(), "-listbox")) {
          if (_this3.inputRef) {
  ...
  Object.defineProperty(this, "handleInputSubmit", {
    ...
    writable: true,
    value: function value(event) {
      if (_this3.state.activeOption && _this3.state.activeOption.disabled) {
        return;
      } // use menu options
  ...
  Object.defineProperty(this, "handleKeyDown", {
    ...
    value: function value(event) {
      ...
      var callbacks = (_callbacks = {}, _defineProperty(_callbacks, _keyCode2.default.DOWN, {
      ...
      if (_this3.props.variant === 'readonly') {
        if (_this3.props.selection.length > 2) {
          callbacks[_keyCode2.default.TAB] = {
            callback: _this3.handleKeyDownTab
          };
        } else {
          callbacks[_keyCode2.default.TAB] = undefined;
        }

        callbacks.other = {
          callback: _this3.handleKeyDownOther,
  ...
  Object.defineProperty(this, "handleKeyDownTab", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value() {
      if (_this3.selectedListboxRef) {
        _this3.setState({
  ...
  Object.defineProperty(this, "handleKeyDownOther", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(event) {
      var activeOptionIndex = (0, _keyLetterMenuItemSelect2.default)({
        key: event.key,
        keyBuffer: _this3.menuKeyBuffer,
      ...
      if (activeOptionIndex !== undefined) {
        if (_this3.state.isOpen) {
          (0, _menuItemSelectScroll2.default)({
            container: _this3.menuRef,
            focusedIndex: activeOptionIndex
          });
        }

        _this3.setState({
          activeOption: _this3.props.options[activeOptionIndex],
  ...
  Object.defineProperty(this, "handleNavigateSelectedListbox", {
    configurable: true,
    enumerable: true,
    writable: true,
  ...
  Object.defineProperty(this, "handlePillClickSelectedListbox", {
    configurable: true,
    enumerable: true,
    writable: true,
  ...
  Object.defineProperty(this, "handlePillFocus", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value() {
      if (!_this3.state.listboxHasFocus) {
        _this3.setState({
          listboxHasFocus: true
        });
      }
  ...
  Object.defineProperty(this, "handleRequestFocusSelectedListbox", {
    configurable: true,
    enumerable: true,
    writable: true,
    ...
    value: function value(_ref10) {
      ...
      return _react2.default.createElement("div", {
        ...
        events: {
          ...
          onClickPill: _this3.handlePillClickSelectedListbox,
          onPillFocus: _this3.handlePillFocus,
          onRequestFocus: _this3.handleRequestFocusSelectedListbox,
          onRequestFocusOnNextPill: _this3.handleNavigateSelectedListbox,
          onRequestFocusOnPreviousPill: _this3.handleNavigateSelectedListbox,
          onRequestRemove: _this3.handleRemoveSelectedOption
        },
        id: "".concat(_this3.getId(), "-selected-listbox"),
        labels: labels,
        selectedListboxRef: _this3.setSelectedListboxRef,
  ...
  Object.defineProperty(this, "renderMenu", {
    ...
    value: function value(_ref13) {
      ...
      return _react2.default.createElement(_menu2.default, {
        ...
        tooltipMenuItemDisabled: _this3.props.tooltipMenuItemDisabled,
