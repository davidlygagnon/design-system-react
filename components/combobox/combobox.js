...
var _direction = require("../utilities/direction");
...
var propTypes = {
   ...
   */
  direction: _propTypes.default.oneOf([_direction.DIRECTIONS.LTR, _direction.DIRECTIONS.RTL]),
   ...
   */
  readOnlyMenuItemVisibleLength: _propTypes.default.oneOf([5, 7, 10]),
...
var defaultProps = {
  ...
  direction: _direction.DIRECTIONS.LTR,
  events: {},
  labels: {
    cancelButton: 'Cancel',
    doneButton: "Done",
...
function (_React$Component) {
  ...
  function Combobox(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getCustomPopoverProps", function (body, _ref) {
       ...
       */
      var popoverBody = _react.default.createElement("div", null, _react.default.createElement("div", {
        className: "slds-assistive-text",
        id: "".concat(_this.getId(), "-label")
      }, assistiveText.popoverLabel), body);

      var popoverFooter = _react.default.createElement("div", null, _react.default.createElement(_button.default, {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderBase", function (_ref11) {
      ...
      return _react.default.createElement("div", {
        ...
        ,
        role: "combobox"
      }, _react.default.createElement(_innerInput.default, _extends({
      ...
      }))), _react.default.createElement(_selectedListbox.default, {
      ...
      }), props.errorText && _react.default.createElement("div", {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderInlineMultiple", function (_ref12) {
      ...
      }, props.selection.length ? _react.default.createElement(_selectedListbox.default, {
        activeOption: _this.state.activeSelectedOption,
        activeOptionIndex: _this.state.activeSelectedOptionIndex,
        assistiveText: assistiveText,
        events: {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderInlineSingle", function (_ref13) {
      ...
      var iconLeft = props.selection[0] && props.selection[0].icon ? _react.default.cloneElement(props.selection[0].icon, {
      ...
      return _react.default.createElement("div", {
        ...
        iconRight: props.selection.length ? _react.default.createElement(_inputIcon.default, {
          assistiveText: {
        ...
        }) : _react.default.createElement(_inputIcon.default, {
          category: "utility",
          name: "search"
        }),
        iconLeft: iconLeft,
    ...
    _defineProperty(_assertThisInitialized(_this), "renderPopover", function (_ref15) {
      ...
      return _react.default.createElement("div", {
        ...
        ,
        role: "combobox"
      }, _react.default.createElement(_popover.default, popoverProps, _react.default.createElement(_innerInput.default, {
  ...
  _createClass(Combobox, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps.default)(_constants.COMBOBOX, this.props, _docs.default);
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (!(0, _lodash4.default)(this.props.options, nextProps.options)) {
        var index = (0, _lodash5.default)(nextProps.options, function (item) {
    ...
    value: function getDialog(_ref18) {
      ...
      var alignment = this.props.direction === _direction.DIRECTIONS.RTL ? 'bottom right' : 'bottom left';
      return !this.props.disabled && this.getIsOpen() ? _react.default.createElement(_dialog.default, {
        align: alignment,
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        label: labels.label,
        required: props.required
      }), this.props.fieldLevelHelpTooltip && hasRenderedLabel ? _react.default.createElement(_fieldLevelHelpTooltip.default, {
