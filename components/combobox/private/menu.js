define(['exports', 'react', 'prop-types', 'lodash.isequal', 'classnames', 'airbnb-prop-types', '../../icon'], function (exports, _react, _propTypes, _lodash, _classnames, _airbnbPropTypes, _icon) {
	'use strict';
   ...
   */
		...
		/**
   * Accepts a custom menu item separator rendering function that becomes a custom component and is passed in the following props:
   * * `assistiveText`: Object, `assistiveText` prop that is passed into Combobox
   * * `option`: Object, option data for item separator being rendered that is passed into Combobox
   *
   */
		menuItemSeparator: _propTypes2.default.func,
		/*
   * Menu options
   */
   ...
   */
	...
	var Menu = function Menu(props) {
		var menuOptions = props.options.map(function (optionData, index) {
			...
			var MenuItemSeparator = props.menuItemSeparator;

			if (optionData.type === 'separator') {
				var DefaultSeparator = optionData.label ? _react2.default.createElement(
					'span',
					{ className: 'slds-text-title_caps' },
					optionData.label
				) : _react2.default.createElement('li', { className: 'slds-has-divider_top-space', role: 'separator' });
				return props.menuItemSeparator ? _react2.default.createElement(MenuItemSeparator, {
					...
					_react2.default.createElement(DefaultSeparator, null)
				);
			}
