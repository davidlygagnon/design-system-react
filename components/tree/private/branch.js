...
var handleKeyDown = function handleKeyDown(event, props) {
	...
	(0, _keyCallbacks2.default)(event, {
		callbacks: (_callbacks = {}, _defineProperty(_callbacks, _keyCode2.default.DOWN, { callback: function callback(evt) {
				return handleKeyDownDown(evt, props);
			} }), _defineProperty(_callbacks, _keyCode2.default.UP, { callback: function callback(evt) {
				return handleKeyDownUp(evt, props);
			} }), _defineProperty(_callbacks, _keyCode2.default.RIGHT, { callback: function callback(evt) {
				return handleKeyDownRight(evt, props);
			} }), _defineProperty(_callbacks, _keyCode2.default.LEFT, { callback: function callback(evt) {
				return handleKeyDownLeft(evt, props);
			} }), _defineProperty(_callbacks, _keyCode2.default.ENTER, { callback: function callback(evt) {
