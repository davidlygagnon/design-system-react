define(['exports', 'react', 'prop-types', 'classnames', './private/branch', './check-props', '../../utilities/constants'], function (exports, _react, _propTypes, _classnames, _branch, _checkProps, _constants) {
	'use strict';
