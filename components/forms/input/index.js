define(['exports', 'react', 'create-react-class', 'prop-types', 'classnames', 'shortid', '../../icon/input-icon', './private/inner-input', '../private/label', './check-props', '../../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _classnames, _shortid, _inputIcon, _innerInput, _label, _checkProps, _constants) {
	'use strict';
