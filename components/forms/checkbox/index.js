define(['exports', 'react', 'create-react-class', 'prop-types', 'lodash.isfunction', 'classnames', 'shortid', '../../../utilities/key-code', '../../../utilities/event', './check-props', '../../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _lodash, _classnames, _shortid, _keyCode, _event, _checkProps, _constants) {
	'use strict';
